...
<div class="footer-inner c-container">
  <div class="footer-nav">
      ...
      <div class="work">
        ...
        <div class="work-item">
          ...
          <ul class="footer-nav-list__item item-col1">
            ...
            <li><a href="<?php echo home_url(); ?>/?s=&post_area=&post_job=生産管理・品質管理&post_tag=">生産管理・品質管理</a></li>
            <li><a href="<?php echo home_url(); ?>/?s=&post_area=&post_job=クリエイティブ&post_tag=">クリエイティブ</a></li>
            <li><a href="<?php echo home_url(); ?>/?s=&post_area=&post_job=ドライバー&post_tag=">ドライバー</a></li>
            <li><a href="<?php echo home_url(); ?>/?s=&post_area=&post_job=その他&post_tag=">その他</a></li>
          </ul>
        </div>
      </div>
      <div class="pickup">
        <h4 class="name">ピックアップ特集からさがす</h4>
      ...
      <div class="about">
        ...
        <div class="about-item">
          <ul class="footer-nav-list__item item-col1">
            ...
            <li><a href="<?php echo home_url(); ?>/speedjobs">スピードジョブス</a></li>
          </ul>
          <ul class="footer-nav-list__item item-col1">
            <li><a href="<?php echo home_url(); ?>/blog">お知らせ</a></li>
            <li><a href="<?php echo home_url(); ?>/information">お役立ち情報</a></li>
          </ul>
          <ul class="footer-nav-list__item item-col1">
            <li><a href="<?php echo home_url(); ?>/contact">お問い合わせ</a></li>
            <li><a href="<?php echo home_url(); ?>/form">応募フォーム</a></li>
          </ul>
        </div>
      </div>
      <div class="menu">
    ...
    <div class="footer-information">
      <div class="information-link"><a href=""><img src="<?php echo get_template_directory_uri(); ?>/assets/images/common/footer-infomationlink.jpg" alt="求人掲載をご希望の企業様へ"></a></div>
    ...
    <div class="footer-copyright">
      <div class="logo"><a href="<?php echo home_url(); ?>"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/common/footer-logo.png" alt="LIFE LINE GROUP"></a></div>
      <p class="copyright">© 2018 LifeLine Co.,Ltd, created by Dynave.</p>
    </div>
  </div>
</div>