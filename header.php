...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-WJPRKJX"
...
<header id="header" class="header">
  <div class="c-container">
    ...
    <nav class="header-gnav u-lg-max">
       <ul class="header-gnav__list">
         ...
         <li class="item"><a href="<?php echo home_url(); ?>/cat_recruit_way/dispatch/" class="is-current">派遣求人</a></li>
      </ul>
    </nav>
  </div>
  <div class="header-navsp">
    ...
    <div class="navsp-sns">
      ...
      <div class="sns-fb"><a href="https://line.me/R/ti/p/c7-u3URgu1" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/common/header-sns2.png" alt=""></a></div>
    </div>
  </div>
</header>
